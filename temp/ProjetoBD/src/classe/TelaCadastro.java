...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btmCadastro = new javax.swing.JButton();
        jPanel2 = new javax.swing.JPanel();
        btmListagem = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        tblLista = new javax.swing.JTable();
        btmLimpar = new javax.swing.JButton();
        btmDeletThis = new javax.swing.JButton();
        ...
        btmCadastro.setText("Cadastrar");
        btmCadastro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmCadastroActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btmCadastro, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        jTabbedPane1.addTab("Cadastrar", jPanel1);

        btmListagem.setText("listagem");
        btmListagem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmListagemActionPerformed(evt);
            }
        });
        ...
        btmDeletThis.setText("deletar");
        btmDeletThis.setEnabled(false);
        btmDeletThis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btmDeletThisActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btmDeletThis)
                .addGap(18, 18, 18)
                .addComponent(btmLimpar)
                .addGap(18, 18, 18)
                .addComponent(btmListagem)
                .addContainerGap())
    ...
    private void btmCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmCadastroActionPerformed
    ...
    }//GEN-LAST:event_btmCadastroActionPerformed

    private void btmListagemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmListagemActionPerformed
        Livro s = new Livro();
        try {
            if(s.list(tblLista))
                btmDeletThis.setEnabled(true);
        } catch (Exception ex) {
            Logger.getLogger(TelaCadastro.class.getName()).log(Level.SEVERE, null, ex);
        }        
    }//GEN-LAST:event_btmListagemActionPerformed
    ...
    private void btmDeletThisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmDeletThisActionPerformed
        try{
    ...
    }//GEN-LAST:event_btmDeletThisActionPerformed
    ...
    private javax.swing.JButton btmCadastro;
    private javax.swing.JButton btmDeletThis;
    private javax.swing.JButton btmLimpar;
    private javax.swing.JButton btmListagem;
